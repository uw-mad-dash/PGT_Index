...
class seq_seq_EnglandCovidDatasetLoader(object):
    ...
    def _get_edge_weights(self):
        ...
        self._edge_weights = self._edge_weights[0]
    ...
    def _get_targets_and_features(self):
        ...
        standardized_target = (stacked_target - self.mean) / self.std
        
        self.features = [
            standardized_target[i : i + self.lags, :]
            for i in range(self._dataset["time_periods"] - self.lags - self.lags)
        ]
